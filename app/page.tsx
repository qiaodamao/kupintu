...
const FEATURES = [
  {
    ...
    title: '海量布局模板',
    desc: '1~16 张图片智能布局，数十种专业模板一键套用，拖动分割线还能自由调整格子大小。',
  },
  {
...
const FAQS = [
  ...
  {
    q: '最多可以拼多少张图？',
    a: '布局模式最多支持 16 张图片，提供数十种模板；长图拼接模式不限制拼接数量，可以拼出超长图。',
  },
  {
    q: '导出的图片清晰吗？',
  ...
  '@graph': [
    {
      ...
      description:
        '酷拼图是一款免费在线拼图工具，支持 1~16 张网格布局与横竖长图拼接，可调间距、圆角、背景与标注，4K 高清无水印导出，图片不上传服务器。',
      inLanguage: 'zh-CN',
